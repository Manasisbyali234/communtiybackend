...
exports.getMatches = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    if (!myProfile)
        throw new ApiError_1.ApiError(404, 'Create your profile first to see matches');
...
exports.expressInterest = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    if (existing)
        throw new ApiError_1.ApiError(409, 'Interest already sent');
...
exports.respondInterest = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    res.json(new ApiResponse_1.ApiResponse(200, updated, `Interest ${status.toLowerCase()}`));
});
