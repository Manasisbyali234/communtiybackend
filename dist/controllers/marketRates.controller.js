...
exports.getMarketRates = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const { crop, date } = req.query;
    if (!crop || typeof crop !== 'string') {
        throw new ApiError_1.ApiError(400, 'crop query parameter is required');
    }
    ...
    const records = await database_1.prisma.marketRate.findMany({
        where,
...
//# sourceMappingURL=marketRates.controller.js.map