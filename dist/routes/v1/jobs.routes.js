...
router.get('/employers/public', jobs_controller_1.listEmployersPublic);
// ── Employer routes (admin) ──────────────────────────────────────────────────────────
router.get('/employers', adminAuth_1.adminAuth, jobs_controller_1.listEmployers);
router.post('/employers', adminAuth_1.adminAuth, jobs_controller_1.createEmployer);
router.post('/employers/upload-logo', adminAuth_1.adminAuth, upload_1.upload.single('file'), jobs_controller_1.uploadEmployerLogo);
router.get('/employers/:id', adminAuth_1.adminAuth, jobs_controller_1.getEmployer);
router.put('/employers/:id', adminAuth_1.adminAuth, jobs_controller_1.updateEmployer);
router.delete('/employers/:id', adminAuth_1.adminAuth, jobs_controller_1.deleteEmployer);
...
router.post('/upload-resume', auth_1.auth, upload_1.upload.single('file'), jobs_controller_1.uploadResume);
