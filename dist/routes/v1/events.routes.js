...
const CreateEventSchema = zod_1.z.object({
    ...
    startsAt: zod_1.z.string().refine(v => !isNaN(Date.parse(v)), { message: 'Invalid date' }),
    endsAt: zod_1.z.string().refine(v => !isNaN(Date.parse(v)), { message: 'Invalid date' }).optional(),
...
router.patch('/:id/archive', events_controller_1.eventsController.archive);
